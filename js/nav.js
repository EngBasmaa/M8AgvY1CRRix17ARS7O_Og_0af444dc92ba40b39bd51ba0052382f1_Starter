...
(function (_0x5f54ad, _0x354d83) {
  ...
  while (!![]) {
    try {
      var _0x44e1e6 =
        -parseInt(_0x329bfe(0x197)) / 0x1 +
        -parseInt(_0x329bfe(0x182)) / 0x2 +
        parseInt(_0x329bfe(0x190)) / 0x3 +
        -parseInt(_0x329bfe(0x18a)) / 0x4 +
        (-parseInt(_0x329bfe(0x191)) / 0x5) *
          (-parseInt(_0x329bfe(0x19d)) / 0x6) +
        -parseInt(_0x329bfe(0x196)) / 0x7 +
        (-parseInt(_0x329bfe(0x18d)) / 0x8) *
          (-parseInt(_0x329bfe(0x186)) / 0x9);
      if (_0x44e1e6 === _0x354d83) break;
      else _0x37204d["push"](_0x37204d["shift"]());
    } catch (_0x3c3559) {
...
function fadeScrollReminders() {
  ...
  const _0x6ce35c = 0.8,
    _0x45537b = 0x4;
  var _0x5857e8 =
    $(document)[_0x234d6c(0x187)]() -
    ($(window)["innerHeight"]() + $(window)[_0x234d6c(0x194)]()) -
    0x78;
  _0x5857e8 < $(window)[_0x234d6c(0x18b)]()
    ? ((alpha = _0x5857e8 / $(window)[_0x234d6c(0x18b)]()),
...
function _0x450e(_0x3517e9, _0x3da8cb) {
  ...
  return (
    (_0x450e = function (_0x450e5a, _0x534fdf) {
...
function _0x2fc5() {
  var _0x5a0d0b = [
    "255936IYNnDn",
    "innerHeight",
    "<i\x20class=\x22far\x20fa-star\x22></i>",
    "16Avpmvu",
    "isInViewport",
    "html,body",
    "1466439ybigsm",
    ...
    "bottom-of-document",
    "78DHtuOO",
    ".section-visual-boundry",
    "scroll",
    "<i\x20class=\x22fas\x20fa-star\x22></i>",
    "tooltip",
    "-section-indicator",
    "load",
    "animate",
...
function scrollToNextSection() {
  ...
  $(".section-visual-boundry")[_0x1e8473(0x195)](function () {
    ...
    if (!_0x466063) {
      ...
      if ($(this)[_0x459d34(0x18e)]()) !_0x3d12d3 && (_0x3d12d3 = !![]);
      else {
        if (_0x3d12d3) scrollToAnchor(_0x64934d), (_0x466063 = !![]);
        else {
        }
      }
    }
  });
  if (!_0x466063) scrollToAnchor(_0x1e8473(0x19c));
}
    ...
    !_0x6375fe &&
      (!_0x9058aa
        ? $(this)["isInViewport"]()
          ? (_0x9058aa = !![])
          : (_0x1d9d96 = _0x2f3c25)
        : (scrollToAnchor(_0x1d9d96), (_0x6375fe = !![])));
  }),
...
function updateSectionIndicators() {
  ...
  toolTipReset(),
    $(".section-visual-boundry")[_0x430e4f(0x195)](function () {
      ...
      $(this)[_0x3543d5(0x18e)]()
        ? $("#" + _0xb9725b + _0x3543d5(0x17f))[_0x3543d5(0x199)](_0x28eb77)
        : $("#" + _0xb9725b + "-section-indicator")[_0x3543d5(0x199)](
            _0x570441
          );
    });
}
